function Frame1597879560() {
  return (
    <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
      <p className="font-['Neue_Haas_Grotesk_Display:Regular',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[#b91a00] text-[14px] text-nowrap tracking-[0.28px] whitespace-pre">{`>> join the conversation`}</p>
    </div>
  );
}
...
export default function CommentInput() {
  return (
    <div className="bg-[#ffd2b5] relative rounded-[2px] size-full" data-name="comment-input">
      <div aria-hidden="true" className="absolute border border-[#6d6153] border-solid inset-0 pointer-events-none rounded-[2px]" />
