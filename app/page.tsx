                ...
                {components.map((component) => (
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link href={`/components/${component.id}`} className="flex items-center gap-3 cursor-pointer">
                    ...
                    <td className="px-6 py-4">
                      <Link href={`/components/${component.id}`} className="block cursor-pointer">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <Link href={`/components/${component.id}`} className="inline-flex items-center justify-end gap-2 text-sm text-gray-500 group-hover:text-gray-700 ml-auto cursor-pointer">
                        <span>View</span>
